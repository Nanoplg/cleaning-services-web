  ...
  hero.innerHTML = `
    <div class="cleaning-hero-stage">
      <article class="cleaning30-layout cleaning-hero-slide is-active" data-cleaning-slide="30" aria-hidden="false">
        ...
        <div class="cleaning30-visual cleaning-hero-visual cleaning-hero-visual-30" role="img" aria-label="Control final profesional de un sillón claro recién tratado" style="background-image:url('assets/respaldo-cleaning-30.avif?v=20260909-8');background-position:58% 57%;"></div>
      </article>
